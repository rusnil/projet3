...
public class NeighboursListTest {
    ...
    @Test
    public void click_on_neighbour_show_details_with_infos() {
    ...
    @Test
    public void neighbour_name_in_TextView() {
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.item_list_name), withText("Jack"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.name2), withText("Jack"),
    ...
    @Test
    public void neighbour_add_in_favoriteFragment() {
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.item_list_name), withText("Jack"),
                        childAtPosition(
                                childAtPosition(
